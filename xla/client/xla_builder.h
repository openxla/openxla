...
class XlaBuilder {
 public:
  ...
  // `target_index` of parameter or output target `target_num` is a dynamic
  // dimension and its real dynamic size is represented by `dynamic_param_index`
  // in parameter `dynamic_param_num`.
  //
