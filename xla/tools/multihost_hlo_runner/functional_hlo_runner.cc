...
bool AbslParseFlag(absl::string_view text, InputFormat* input_format,
  ...
  if (text == "input_snapshot_proto_binary") {
    *input_format = InputFormat::kInputSnapshotProtoBinary;
    return true;
  }

  if (text == "input_snapshot_proto_text") {
    *input_format = InputFormat::kInputSnapshotProtoText;
    return true;
  }
...
std::string AbslUnparseFlag(InputFormat input_format) {
  switch (input_format) {
    ...
    case InputFormat::kInputSnapshotProtoBinary:
      return "input_snapshot_proto_binary";
    case InputFormat::kInputSnapshotProtoText:
...
FunctionalHloRunner::LoadHloModuleAndArguments(absl::string_view hlo_file,
  ...
  switch (input_format) {
    ...
    case InputFormat::kInputSnapshotProtoBinary: {
      TF_ASSIGN_OR_RETURN(hlo_module_and_arguments,
                          ReadModuleFromInputSnapshotBinaryProtoFile(hlo_file));
      break;
    }
    case InputFormat::kInputSnapshotProtoText: {
      TF_ASSIGN_OR_RETURN(hlo_module_and_arguments,
                          ReadModuleFromInputSnapshotTextProtoFile(hlo_file));
      break;
    }
    default:
...
absl::StatusOr<FunctionalHloRunner::HloModuleAndArguments>
FunctionalHloRunner::ReadModuleFromInputSnapshotBinaryProtoFile(
    absl::string_view hlo_file) {
...
absl::StatusOr<FunctionalHloRunner::HloModuleAndArguments>
FunctionalHloRunner::ReadModuleFromInputSnapshotTextProtoFile(
    absl::string_view hlo_file) {
  HloUnoptimizedSnapshot proto;
  HloModuleAndArguments hlo_module_and_arguments;
  TF_RETURN_IF_ERROR(
